...
- الهوية البصرية: داكنة بأسلوب UULA — خلفية `#0f1217`، أسطح `#161c29`/`#1a2130`، حدود `#2b3547`، أزرق `#2072e0` (hover `#1b63c4`، نص فاتح `#4a9bf5`)، نص ثانوي `#99a8bd`، ذهبي `#f59e0b` — خط Alexandria، RTL. كل الصفحات (طالب/ولي أمر/أدمن) على `AppShell dark`.
