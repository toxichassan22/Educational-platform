...
- **للطالب:** داشبورد تفاعلي (مستوى + XP + سلسلة يومية + أوسمة + متصدرون)، دروس فيديو + مذكرات PDF، **استكمال المشاهدة وملاحظات بتوقيت الفيديو**، اختبارات موقوتة بتصحيح فوري ومراجعة إجابات مع الشرح، **خطة مراجعة من أخطائه + تدريب متابعة بأسئلة مختلفة ومقارنة بالمحاولة السابقة**، تقارير نقاط قوة وضعف، بحث في كل المنهج.
