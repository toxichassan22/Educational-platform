...
const PATHS: Record<string, React.ReactNode> = {
  ...
  medal: <><circle cx="12" cy="14" r="6" /><path d="M12 12l1.2 2.4 2.6.4-1.9 1.9.5 2.7-2.4-1.3-2.4 1.3.5-2.7-1.9-1.9 2.6-.4L12 12z" fill="currentColor" stroke="none" /><path d="M8.5 8.8L5 2h4l3 4 3-4h4l-3.5 6.8" /></>,
  laurel: <><path d="M12 21c-4 0-8-3.5-8-9 0-1 .1-2 .4-3" /><path d="M12 21c4 0 8-3.5 8-9 0-1-.1-2-.4-3" /><path d="M7 3.5C8 5 8 6.5 7 8.5M4.5 6C5.8 7.4 6.3 8.8 6 10.8M17 3.5C16 5 16 6.5 17 8.5M19.5 6C18.2 7.4 17.7 8.8 18 10.8" /></>,
  fb: <path d="M15 3h-2.5A4.5 4.5 0 0 0 8 7.5V10H5.5v4H8v7h4v-7h3l.5-4H12V7.5c0-.6.4-1 1-1H15V3z" />,
  xlogo: <path d="M4 4l7.2 9.3L4.4 20h2.5l5.4-5.5L16.8 20H20l-7.5-9.7L19.4 4h-2.5l-4.9 5.1L8 4H4z" />,
  yt: <><rect x="2" y="5.5" width="20" height="13" rx="4" /><path d="M10 9.5l5 2.5-5 2.5v-5z" fill="currentColor" stroke="none" /></>,
